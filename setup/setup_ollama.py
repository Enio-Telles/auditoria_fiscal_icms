...
def setup_ollama_system():
    ...
    print("=" * 60)
    print(f"✅ Ollama rodando em: http://localhost:11434")
    print(f"✅ Modelos disponíveis: {', '.join(modelos_instalados)}")
    print(f"✅ Sistema pronto para classificação de produtos!")
    print(f"\n💡 Para testar:")
    print(f"   python src/auditoria_icms/ai/local_llm_classifier.py --test")
