...
def setup_central_database():
    ...
    try:
        ...
        Base.metadata.create_all(
            engine,
            tables=[Usuario.__table__, Empresa.__table__, PermissaoEmpresa.__table__],
        )
...
def setup_golden_set_database():
    ...
    try:
        ...
        Base.metadata.create_all(
            engine, tables=[GoldenSetNCM.__table__, GoldenSetCEST.__table__]
        )
...
def register_empresa_in_central(cnpj, razao_social, database_name, **kwargs):
    ...
    try:
        ...
        nova_empresa = Empresa(
            cnpj=cnpj, razao_social=razao_social, database_name=database_name, **kwargs
        )
