...
async def get_statistics():
    ...
    stats = {
        ...
        "versao": "2.2.0",
        "status": "operational",
        "golden_set": {"ncm_items": 150, "cest_items": 800},
...
async def preview_import_data(config: DatabaseConfig, sql_query: str, limit: int = 10):
...
async def execute_import(
    config: DatabaseConfig, sql_query: str, empresa_id: Optional[str] = None
):
    ...
    try:
        ...
        for produto in produtos_teste:
            try:
                ...
                resultados.append(
                    {"produto": produto, "erro": str(e), "ncm_sugerido": "0000.00.00"}
                )
        ...
        return {"error": f"Erro na demonstração de IA: {str(e)}", "status": "erro"}
