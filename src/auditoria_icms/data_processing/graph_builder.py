...
class GraphBuilder:
    ...
    def create_ncm_hierarchy_nodes(self) -> Dict[str, int]:
        ...
        if self.driver:
            ...
            # Simulação
            nodes_created = (
                len(capitulos) + len(posicoes) + len(subposicoes) + len(subitems)
            )
        ...
        cest_data = [
            {
                ...
                "segmento_id": 1,
                "segmento_desc": "Medicamentos",
            },
            {
                "cest": "21.001.00",
                "descricao": "Aparelhos telefônicos",
                "segmento_id": 2,
                "segmento_desc": "Telecomunicações",
            },
            {
                "cest": "28.064.00",
                "descricao": "Artigos de vestuário infantil",
                "segmento_id": 3,
                "segmento_desc": "Vestuário",
            },
        ]
    ...
    def create_ncm_cest_relationships(self) -> Dict[str, int]:
        ...
        associations = [
            ...
            {
                "cest": "21.001.00",
                "ncm_pattern": "85171211",
                "tipo": "especifico",
                "nivel": "subitem",
            },
            {
                "cest": "21.001.00",
                "ncm_pattern": "85171212",
                "tipo": "especifico",
                "nivel": "subitem",
            },
        ]
    ...
    def create_product_nodes(self) -> Dict[str, int]:
        ...
        products = [
            ...
            {
                "gtin": "7891234567891",
                "descricao": "SMARTPHONE GALAXY A54",
                "ncm": "85171211",
                "marca": "Samsung",
            },
            {
