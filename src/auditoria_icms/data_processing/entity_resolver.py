...
class EntityResolver:
    ...
    def calculate_similarity(
        self, text1: str, text2: str, method: str = "ratio"
    ) -> float:
            ...
            simulated_duplicates = [
                {
                    "nodes": [
                        {
                            "codigo": "30049069",
                            "descricao": "Outros medicamentos constituídos por produtos misturados",
                        },
                        {
                            "codigo": "30049069",
                            "descricao": "OUTROS MEDICAMENTOS CONSTITUIDOS POR PRODUTOS MISTURADOS",
                        },
                    ],
                    "similarity": 0.92,
                        ...
                        duplicates.append(
                            {
                                ...
                                "conflict_type": (
                                    "same_code"
                                    if n1["codigo"] == n2["codigo"]
                                    else "similar_description"
                                ),
                            }
                        )
            ...
            simulated_duplicates = [
                {
                    "nodes": [
                        {
                            "gtin": "7891234567890",
                            "descricao": "DIPIRONA SODICA 500MG",
                            "marca": "Medley",
                        },
                        {
                            "gtin": "7891234567899",
        ...
        try:
            with self.driver.session() as session:
                ...
                for record in result:
                    ...
                    ):  # Threshold mais baixo para produtos
                        duplicates.append(
                            {
    ...
    def _link_similar_ncm_nodes(self, node1: Dict, node2: Dict):
        ...
        try:
            with self.driver.session() as session:
                ...
                similarity = self.calculate_similarity(
                    node1["descricao"], node2["descricao"]
                )
    ...
    def generate_entity_resolution_report(self) -> Dict:
        ...
        report = {
            ...
            "duplicates": {"ncm": ncm_duplicates, "products": product_duplicates},
            "resolutions": {"ncm": ncm_resolutions, "products": product_resolutions},
