...
class DocumentExtractor:
        ...
        try:
            ...
            notas_simuladas = [
                ...
                },
                {
                    ...
                    "texto": (
                        "Medicamentos (exceto posições 30.02, 30.05 ou 30.06) "
                        "constituídos por produtos misturados ou não, preparados "
                        "para fins terapêuticos ou profiláticos."
                    ),
                    "nivel": 2,
                    "origem": "NESH",
                },
                {
                    ...
                    "texto": (
                        "Classificação rege-se por Regras: títulos de Seções, Capítulos "
                        "e Subcapítulos têm apenas valor indicativo."
                    ),
                    "nivel": 1,
        ...
        try:
            ...
            for i, paragraph in enumerate(doc.paragraphs):
                ...
                if text and len(text) > 50:  # Filtra parágrafos significativos
                    ...
                    capitulo_matches = re.findall(
                        r"\bCapítulo\s+(\d{1,2})\b", text, re.IGNORECASE
                    )
    ...
    def process_all_documents(self) -> Dict[str, List[Dict]]:
        ...
        results = {"nesh_notes": [], "regras_gerais": [], "other_documents": []}
    ...
    def save_extracted_data(self, data: Dict, output_file: str = None):
        ...
        if output_file is None:
            output_file = os.path.join(
                self.data_dir, "..", "processed", "extracted_documents.json"
            )
