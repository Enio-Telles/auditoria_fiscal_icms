...
class NeshProcessor:
    ...
    def _get_known_regras_gerais(self) -> Dict:
        ...
        return {
            "1": {
                ...
                "texto": "Os títulos das Seções, Capítulos e Subcapítulos têm apenas valor indicativo. Para os efeitos legais, a classificação é determinada pelos textos das posições e das Notas de Seção e de Capítulo e, desde que não sejam contrárias aos textos das referidas posições e Notas, pelas Regras seguintes.",
            ...
            "2A": {
                ...
                "texto": "Qualquer referência a um artigo em determinada posição abrange esse artigo mesmo incompleto ou não acabado, desde que apresente, no estado em que se encontra, as características essenciais do artigo completo ou acabado.",
                "tipo": "Regra Geral de Interpretação",
            ...
            "2B": {
                ...
                "texto": "Qualquer referência a uma matéria em determinada posição abrange essa matéria mesmo misturada ou associada a outras matérias. Da mesma forma, qualquer referência a obras de uma matéria determinada abrange as obras constituídas inteira ou parcialmente por essa matéria.",
                "tipo": "Regra Geral de Interpretação",
            ...
            "3B": {
                ...
                "texto": "Os produtos compostos, as obras constituídas por matérias diferentes ou constituídas pela reunião de artigos diferentes e as mercadorias apresentadas em sortidos classificam-se pela matéria ou artigo que lhes confira o caráter essencial, quando for possível determiná-lo.",
                "tipo": "Regra Geral de Interpretação",
        ...
        return {
            "regras_gerais": {
                ...
                "rg5a": {
                    ...
                    "descricao": "Os estojos para aparelhos fotográficos, para instrumentos de música, para armas, para instrumentos de desenho, os colares e os artigos semelhantes, especialmente concebidos para conter um artigo determinado ou um sortido, e suscetíveis de uso prolongado, seguem o regime aduaneiro dos artigos que contêm quando apresentados com esses artigos.",
                ...
                "rg5b": {
                    ...
                    "descricao": "Sem prejuízo da Regra 5(a), as embalagens que contenham mercadorias seguem o regime aduaneiro dessas mercadorias quando são do tipo normalmente utilizado para o acondicionamento de tais mercadorias. Contudo, esta disposição não é obrigatória quando as embalagens são claramente suscetíveis de utilização repetida.",
                ...
                "rg6": {
                    "titulo": "Regra Geral 6 - Classificação de mercadorias nas subposições",
                    "descricao": "A classificação de mercadorias nas subposições de uma mesma posição é determinada, para efeitos legais, pelos textos dessas subposições e das Notas de subposição respectivas, bem como, mutatis mutandis, pelas Regras precedentes.",
                    "aplicacao": "Aplicar as mesmas regras para subposições dentro de uma posição",
                    "exemplos": [
                        "Dentro da posição 8471 (máquinas de processamento de dados), aplicar regras para determinar subposição específica"
                    ]
                }
            },
            "estrutura_ncm": {
    ...
    def _create_sample_nesh_data(self) -> Dict:
        ...
        return {
            ...
            "capitulos": {
                "30": {"titulo": "Produtos farmacêuticos", "abrangencia": "Medicamentos"},
    ...
    for i, produto in enumerate(produtos_teste, 1):
        ...
        for regra in resultado['regras_aplicadas']:
            ...
            if regra.get('classificacao_definida'):
                print(f"    ✓ Classificação definida")
