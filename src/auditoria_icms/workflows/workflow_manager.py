...
class WorkflowManager:
    ...
    async def process_product(
        ...
        try:
            ...
            result = self._create_workflow_result(
                workflow_type, final_state, execution_time
            )
    ...
    def _determine_workflow_type(self, produto_dados: Dict[str, Any]) -> WorkflowType:
        ...
        # cest_informado removido (não utilizado)
    ...
    def _prepare_initial_state(
        self, produto_dados: Dict[str, Any], empresa_id: Optional[str]
    ) -> Dict[str, Any]:
    ...
    async def _execute_confirmation_workflow(
    ...
    async def _execute_determination_workflow(
        self, state: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _execute_hybrid_workflow(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if (
                confirmation_state.get("status") == "CONFIRMADO"
                and confirmation_state.get("final_confidence", 0.0)
...
async def classify_product(
    ...
    return await workflow_manager.process_product(
        produto_dados, empresa_id, workflow_type
    )
...
async def classify_batch(
    ...
    return await workflow_manager.process_batch(
        produtos_list, empresa_id, max_concurrent
    )
