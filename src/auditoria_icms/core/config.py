...
def load_settings_from_env() -> Settings:
    ...
    agent_config = AgentConfig(
        ...
        enable_ncm_classification=os.getenv("ENABLE_NCM_CLASSIFICATION", "true").lower() == "true",
        enable_cest_classification=os.getenv("ENABLE_CEST_CLASSIFICATION", "true").lower() == "true",
