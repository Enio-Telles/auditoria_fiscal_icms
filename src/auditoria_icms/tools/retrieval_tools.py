...
class RetrievalTools:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.sqlite_path = config.get('relational_store', {}).get('database_path', 'data/processed/knowledge_base.sqlite')
        self.faiss_index_path = config.get('vector_store', {}).get('index_path', 'data/processed/faiss_index')
    ...
    async def _init_embeddings(self):
        ...
        try:
            ...
            model_name = self.config.get('embeddings', {}).get('model_name', 'BAAI/bge-m3')
            self.embeddings_model = SentenceTransformer(model_name)
            self.logger.info(f"Modelo de embeddings carregado: {model_name}")
            
        except ImportError:
            self.logger.warning("sentence-transformers não disponível - busca semântica desabilitada")
        except Exception as e:
    ...
    async def _init_neo4j(self):
        ...
        try:
            ...
            self.logger.warning("Neo4j driver não disponível - busca em grafo desabilitada")
        except Exception as e:
    ...
    async def search_positions(self, description: str, chapter: str) -> List[Dict[str, Any]]:
    ...
    async def search_subpositions(self, description: str, position: str) -> List[Dict[str, Any]]:
    ...
    async def search_items(self, description: str, subposition: str) -> List[Dict[str, Any]]:
    ...
    async def get_cest_info(self, cest: str, estado: str = 'RO') -> Optional[Dict[str, Any]]:
    ...
    async def search_cest_by_ncm(self, ncm: str, estado: str = 'RO') -> List[Dict[str, Any]]:
    ...
    async def search_cest_by_pattern(self, ncm_pattern: str, estado: str = 'RO') -> List[Dict[str, Any]]:
    ...
    async def get_cest_ncm_rules(self, cest: str, estado: str = 'RO') -> List[Dict[str, Any]]:
    ...
    async def semantic_search_products(self, description: str, top_k: int = 5) -> List[Dict[str, Any]]:
    ...
    async def semantic_search_cest(self, description: str, estado: str = 'RO', top_k: int = 5) -> List[Dict[str, Any]]:
    ...
    async def search_golden_set(self, description: str, top_k: int = 3) -> List[Dict[str, Any]]:
