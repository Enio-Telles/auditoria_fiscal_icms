...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("phase6_execution.log")],
)
...
async def run_phase6_demo():
    ...
    try:
        ...
        if not all(
            [
                initial_status.database_ready,
                initial_status.agents_ready,
                initial_status.workflows_ready,
            ]
        ):
    ...
    try:
        ...
        for i, product in enumerate(test_products, 1):
            ...
            try:
                ...
                print(
                    f"   Resultado: {'✅ Sucesso' if enrichment_result.success else '❌ Falha'}"
                )
