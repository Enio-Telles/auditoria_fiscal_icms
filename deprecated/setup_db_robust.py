...
def main():
    ...
    run_docker_command(
        "SELECT COUNT(*) as total_usuarios FROM usuarios;", "Contando usuários"
    )
    run_docker_command(
        "SELECT COUNT(*) as total_empresas FROM empresas;", "Contando empresas"
    )
    run_docker_command(
        "SELECT COUNT(*) as total_produtos FROM produtos;", "Contando produtos"
    )
