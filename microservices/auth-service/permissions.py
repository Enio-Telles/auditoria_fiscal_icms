...
class PermissionRequest(BaseModel):
    ...
    user_id: str
    granted_by: str
    reason: str = Field(..., min_length=10, description="Justificativa para a permissão")
...
class PermissionManager:
    ...
    ROLE_PERMISSIONS = {
        Role.SUPER_ADMIN: {
            ResourceType.EMPRESA: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE, PermissionLevel.ADMIN],
            ResourceType.PRODUTO: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE, PermissionLevel.ADMIN],
            ResourceType.CLASSIFICACAO: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE, PermissionLevel.ADMIN],
            ResourceType.GOLDEN_SET: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE, PermissionLevel.ADMIN],
            ResourceType.RELATORIO: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE, PermissionLevel.ADMIN],
            ResourceType.USUARIO: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE, PermissionLevel.ADMIN],
            ResourceType.SISTEMA: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE, PermissionLevel.ADMIN],
        },
        Role.ADMIN: {
            ResourceType.EMPRESA: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE],
            ResourceType.PRODUTO: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE],
            ResourceType.CLASSIFICACAO: [PermissionLevel.READ, PermissionLevel.WRITE, PermissionLevel.DELETE],
...
async def get_user_permissions(
    user_id: str,
    current_user: User = Depends(require_permission(ResourceType.USUARIO, PermissionLevel.READ)),
    db: Session = Depends(get_db)
):
    """
