...
class StatusVerifier:
    ...
    def verify_required_packages(self):
        ...
        required_packages = [
            ...
            "pandas", "numpy", "requests", "pydantic", "pathlib",
    ...
    def run_all_checks(self):
        ...
        print(f"✅ Verificações passaram: {self.checks_passed}/{self.total_checks} ({success_rate:.1f}%)")
        ...
        if success_rate >= 90:
            ...
            status = "🟡 BOM"
            recommendation = "Sistema funcional, mas recomenda-se resolver problemas menores."
        elif success_rate >= 60:
            status = "🟠 REGULAR" 
            recommendation = "Resolver problemas críticos antes de continuar."
        else:
            status = "🔴 CRÍTICO"
            recommendation = "Sistema não está pronto. Resolver todos os problemas primeiro."
